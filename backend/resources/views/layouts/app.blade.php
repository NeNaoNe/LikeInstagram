                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="dropdown nav-item">
                                <button class="btn btn-shadow-none nav-link" id="account-dropdown"
                                    data-bs-toggle="dropdown">
                                @if (Auth::User()->avatar)
                                    <img src="{{ asset('storage/avatars/' . Auth::User()->avatar) }}" alt="{{ Auth::User()->avatar }}" class="rounded border border-1 rounded-circle"  style="height: 2.1rem; width: 2.18rem;">
                                @else
