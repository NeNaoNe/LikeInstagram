                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <a href="{{ route('profile.show', $post->user->id) }}" class="text-secondary">
                                @if ($post->user->avatar)
                                    <img src="{{ asset('/storage/avatars/' . $post->user->avatar) }}" alt="{{ $post->user->avatar }}" class="rounded-circle user-avatar" style="height: 32px; width:32px;">
                                @else
                        ...
                        <div class="col-auto text-end">
                            ...
                            @else
                                ...
                                <form action="{{ route('follow.destroy', $post->user->id) }}" method="post" class="d-inline">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        class="border-0 bg-transparent text-secondary p-0">Following</button>
                                </form>
                            @endif
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content border-danger">
                ...
                <div class="modal-body">
                    ...
                    <img src="{{ asset('/storage/images/' . $post->image) }}" class="delete-post-img" alt="">
